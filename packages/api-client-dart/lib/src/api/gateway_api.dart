...
class GatewayApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [PublicInquiryResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PublicInquiryResponse>> createPublicInquiry({ 
    required PublicInquiryRequest publicInquiryRequest,
    ...
    final _path = r'/api/v1/public/inquiries';
    ...
    try {
      const _type = FullType(PublicInquiryRequest);
      _bodyData = _serializers.serialize(publicInquiryRequest, specifiedType: _type);
    ...
    PublicInquiryResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PublicInquiryResponse),
    ...
    return Response<PublicInquiryResponse>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BffHomeResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BffHomeResponse>> getBffHome({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    BffHomeResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BffHomeResponse),
      ) as BffHomeResponse;
    ...
    return Response<BffHomeResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
