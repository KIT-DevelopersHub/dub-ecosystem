// Real in-memory SQLite adapter for the audit outbox, seeded with @dub/freeq's
// OUTBOX_DDL so OutboxAuditor + runAuditDrain run against authentic D1 SQL.
// Mirrors services/audit-log/test/d1.ts.
