...
-- Mirror of infra/d1/migrations/mail/0002_inbound_body_read.sql (kept byte-identical;
-- infra #28 is the 正本 / runner, this copy backs the in-memory test schema in test/d1.ts).
