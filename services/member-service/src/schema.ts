...
// された行は NULL のまま（安全に戻せないので取消不可）。Mirrors
// 0010_participation_undo_snapshot.sql (schema-lockstep). SQLite ADD COLUMN は既定値を
// 付けられないため nullable。
export const MEMBER_PARTICIPATION_UNDO_SNAPSHOT_MIGRATION: Migration = {
  namespace: "member",
  id: "0010_participation_undo_snapshot",
  up: `
...
export const MEMBER_MIGRATIONS: readonly Migration[] = [
  ...
  MEMBER_PARTICIPATION_UNDO_SNAPSHOT_MIGRATION,
];
