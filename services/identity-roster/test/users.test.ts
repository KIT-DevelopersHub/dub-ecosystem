...
describe("users listing & detail", () => {
  ...
  it("allows a user to read their own detail without identity:read", async () => {
    ...
    await h.repo.createUser({ id: "user_bare", orgId: ORG_ID, email: "bare@devhub.jp", displayName: "Bare", furigana: null, githubLogin: null, avatarUrl: null, status: "active", source: "manual", createdAt: "t", updatedAt: "t" });
