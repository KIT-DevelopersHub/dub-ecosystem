...
// seeded with the outbox DDL — so the outbox SQL (INSERT OR IGNORE, the status/
// next_attempt_at drain query, the UPDATEs) is exercised authentically, not mocked.
// Mirrors packages/freeq/test/d1.ts. Kept separate from any drive namespace DB helper.
