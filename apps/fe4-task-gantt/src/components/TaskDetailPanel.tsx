...
import { Button, Icon, IconButton, TextField, Select, ConfirmDialog } from "@dub/ui";
...
export function TaskDetailPanel({
  ...
  // changes, so the auto-save effect fires exactly once per distinct edit.
  const signature = useMemo(
    () => JSON.stringify([title, status, priority, assigneeId, teamId, start, due, parentId, [...deps].sort()]),
    [title, status, priority, assigneeId, teamId, start, due, parentId, deps],
  );
