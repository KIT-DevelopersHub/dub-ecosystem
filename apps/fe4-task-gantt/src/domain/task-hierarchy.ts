...
//
// UPDATED SPEC (cross-scope deps / ADR-0006 — supersedes 判断10):
...
//   - different team: NOT allowed (cross-team work goes through the request/approval
//     flow instead — it never draws a dependency arrow)
