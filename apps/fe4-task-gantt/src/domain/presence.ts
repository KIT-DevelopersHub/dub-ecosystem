...
/** Resolve a presence user's best available label: the DO-relayed displayName (if any),
 *  else a roster lookup, else the raw id — so the avatar bar stays populated even before
 *  the roster batch resolves. */
