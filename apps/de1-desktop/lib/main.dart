...
/// Dub desktop/mobile — a thin native shell that renders the real Web SPA.
///
...
///   biometric gate (Touch ID on macOS / Face ID or Touch ID on iOS / Windows
///   Hello) → on success → WebView, into whose login form the saved
