...
//
// A typed login is NOT persisted on submit. It is held in memory and only
// written to the secure store when the user explicitly opts in — via the
// post-login dialog (`enableFromPending`) or the settings toggle (`enable`).
// Declining leaves nothing saved.
